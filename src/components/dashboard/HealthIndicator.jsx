...
export default function HealthIndicator({ status, score }) {
  const configs = {
    healthy: {
      icon: Shield,
    ...
    >
      ...
      <div className="relative flex items-start gap-6">
        <motion.div 
          ...
          className={cn("w-16 h-16 rounded-2xl flex items-center justify-center", config.iconBg)}
        >

      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-7 gap-2 bg-slate-900/50 p-2 rounded-xl">
            <TabsTrigger value="inbox" className="data-[state=active]:bg-emerald-600">
            ...
            <TabsTrigger value="vat" className="data-[state=active]:bg-emerald-600">
              <Percent className="w-4 h-4 mr-2" />
              VAT
            </TabsTrigger>
            <TabsTrigger value="pl" className="data-[state=active]:bg-emerald-600">
            ...
            <TabsTrigger value="accountant" className="data-[state=active]:bg-emerald-600">
              <UserCircle className="w-4 h-4 mr-2" />
              Accountant
            </TabsTrigger>
            <TabsTrigger value="exports" className="data-[state=active]:bg-emerald-600">
